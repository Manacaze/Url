...
<?php
//Nome dos Disritos
$sql="SELECT cod_distrito FROM `frl_cadastro_de_membros` WHERE cod_provincia='$usu_provincia' GROUP BY cod_distrito ASC";
...
//Total de Membros
$sqlT="SELECT frl_cad_id FROM `frl_cadastro_de_membros` WHERE cod_provincia='$usu_provincia'";
$queryT = mysqli_query($con, $sqlT);
$numT = mysqli_num_rows($queryT);

//Total de Membros com Numero
$sqlTN="SELECT numero_cartao FROM `frl_cadastro_de_membros` WHERE numero_cartao != '' AND numero_cartao != 0 AND cod_provincia='$usu_provincia'";
$queryTN = mysqli_query($con, $sqlTN);
$numTN = mysqli_num_rows($queryTN);
//Total de Membros com Numero Provincias
$sqlTN1="SELECT numero_cartao, cod_distrito FROM `frl_cadastro_de_membros` WHERE numero_cartao != '' AND numero_cartao != 0 AND cod_provincia='$usu_provincia' GROUP BY cod_distrito ASC ";
...
$sqlTCE="SELECT numero_cartao_eleitor FROM `frl_cadastro_de_membros` WHERE numero_cartao_eleitor != '' AND numero_cartao_eleitor != 0 AND cod_provincia='$usu_provincia'";
$queryTCE = mysqli_query($con, $sqlTCE);
$numTCE = mysqli_num_rows($queryTCE);
//Total de Membros com Cartao de Eleitor Provincia
$sqlTCE1="SELECT numero_cartao_eleitor, cod_distrito FROM `frl_cadastro_de_membros` WHERE numero_cartao_eleitor != '' AND numero_cartao_eleitor != 0 AND cod_provincia='$usu_provincia' GROUP BY cod_distrito ASC";
...
<div class="row">
    ...
    { ?>
	  ...
	  <?php
                    ...
                    {
                        echo $virgula."'".getRow("sms_distritos", "distrito", "sms_dis_id", $result['cod_distrito'])."'";
                        $virgula=",";
                    }
                    ?>
				  ]
	  ...
	  <?php
                    ...
                    {
                        $sql1 = "SELECT cod_distrito FROM `frl_cadastro_de_membros` WHERE cod_provincia='$usu_provincia' AND cod_distrito=".$result['cod_distrito'];
                        $query2 = mysqli_query($con, $sql1);
                        $num1 = mysqli_num_rows($query2);
                        echo $virgula."{value:".$num1.", name:'".getRow("sms_distritos", "distrito", "sms_dis_id", $result['cod_distrito'])."'}";
                        $virgula=",";
                    }
                    ?>
                      ],
    ...
    { ?>
	  ...
	  <?php
                    ...
                    {
                        $sql1 = "SELECT cod_distrito FROM `frl_cadastro_de_membros` WHERE numero_cartao != '' AND numero_cartao != 0 AND cod_provincia='$usu_provincia' AND cod_distrito=".$result['cod_distrito'];
                        $query2 = mysqli_query($con, $sql1);
                        $num1 = mysqli_num_rows($query2);
                        echo $virgula."{value:".$num1.", name:'".getRow("sms_distritos", "distrito", "sms_dis_id", $result['cod_distrito'])."'}";
                        $virgula=",";
    ...
    { ?>
	  ...
	  <?php
                    ...
                    {
                        $sql1 = "SELECT cod_distrito FROM `frl_cadastro_de_membros` WHERE numero_cartao_eleitor != '' AND numero_cartao_eleitor != 0 AND cod_provincia='$usu_provincia' AND cod_distrito=".$result['cod_distrito'];
                        $query2 = mysqli_query($con, $sql1);
                        $num1 = mysqli_num_rows($query2);
                        echo $virgula."{value:".$num1.", name:'".getRow("sms_distritos", "distrito", "sms_dis_id", $result['cod_distrito'])."'}";
                        $virgula=",";
