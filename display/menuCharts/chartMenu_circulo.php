        ...
        <div class="col-sm-6">
            <div class="box">
                <div class="box-header">
                    ...
                    <small class="block text-muted">Gr&aacute;fico de total de Membros cadastrados por Circulo</small>
                </div>
        ...
        <div class="col-sm-6">
            <div class="box">
                <div class="box-header">
                    ...
                    <small class="block text-muted">Gr&aacute;fico de total de Membros com o numero de membro por Circulo</small>
                </div>
                <div class="box-body tabelaPie">
                </div>
            </div>
        ...
        <div class="col-sm-6">
            <div class="box">
                <div class="box-header">
                    ...
                    <small class="block text-muted">Gr&aacute;fico de total de Membros com cart&atilde;o de eleitor por Cirulo</small>
                </div>
                <div class="box-body tabelaPie">
                </div>
            </div>
